...
const file_app_dns_config_proto_rawDesc = "" +
	"\n" +
	"\x14app/dns/config.proto\x12\fxray.app.dns\x1a\x1ccommon/net/destination.proto\x1a\x17app/router/config.proto\"\xb2\x04\n" +
	"\n" +
	"NameServer\x123\n" +
	...
	"\x0equery_strategy\x18\a \x01(\x0e2\x1b.xray.app.dns.QueryStrategyR\rqueryStrategy\x1a^\n" +
