...
const file_proxy_shadowsocks_2022_config_proto_rawDesc = "" +
	"\n" +
	"#proxy/shadowsocks_2022/config.proto\x12\x1bxray.proxy.shadowsocks_2022\x1a\x18common/net/network.proto\x1a\x18common/net/address.proto\"\x98\x01\n" +
	"\fServerConfig\x12\x16\n" +
	"\x06method\x18\x01 \x01(\tR\x06method\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x12\x14\n" +
	"\x05level\x18\x04 \x01(\x05R\x05level\x122\n" +
	"\anetwork\x18\x05 \x03(\x0e2\x18.xray.common.net.NetworkR\anetwork\"\xae\x01\n" +
	"\x15MultiUserServerConfig\x12\x16\n" +
	"\x06method\x18\x01 \x01(\tR\x06method\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x127\n" +
	"\x05users\x18\x03 \x03(\v2!.xray.proxy.shadowsocks_2022.UserR\x05users\x122\n" +
	...
	"\anetwork\x18\x04 \x03(\x0e2\x18.xray.common.net.NetworkR\anetwork\"D\n" +
	"\x04User\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05email\x18\x02 \x01(\tR\x05email\x12\x14\n" +
	"\x05level\x18\x03 \x01(\x05R\x05level\"\xd6\x01\n" +
	"\fClientConfig\x125\n" +
