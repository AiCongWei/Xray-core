...
const file_proxy_vless_inbound_config_proto_rawDesc = "" +
	"\n" +
	" proxy/vless/inbound/config.proto\x12\x18xray.proxy.vless.inbound\x1a\x1acommon/protocol/user.proto\x1a!common/protocol/addition_id.proto\"\x82\x01\n" +
	"\bFallback\x12\x12\n" +
	...
	"decryption\x12@\n" +
	"\tfallbacks\x18\x03 \x03(\v2\".xray.proxy.vless.inbound.FallbackR\tfallbacks\x12Y\n" +
	"\x12addition_id_policy\x18\x04 \x01(\x0e2&.xray.common.protocol.AdditionIdPolicyH\x00R\x10additionIdPolicy\x88\x01\x01B\x15\n" +
	"\x13_addition_id_policyBj\n" +
