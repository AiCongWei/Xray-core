...
const file_proxy_vless_outbound_config_proto_rawDesc = "" +
	"\n" +
	"!proxy/vless/outbound/config.proto\x12\x19xray.proxy.vless.outbound\x1a!common/protocol/server_spec.proto\x1a!common/protocol/addition_id.proto\"\xec\x01\n" +
	"\x06Config\x12:\n" +
	"\x05vnext\x18\x01 \x03(\v2$.xray.common.protocol.ServerEndpointR\x05vnext\x12$\n" +
	"\vaddition_id\x18\x02 \x01(\x04H\x00R\n" +
	"additionId\x88\x01\x01\x12Y\n" +
	"\x12addition_id_policy\x18\x03 \x01(\x0e2&.xray.common.protocol.AdditionIdPolicyH\x01R\x10additionIdPolicy\x88\x01\x01B\x0e\n" +
	"\f_addition_idB\x15\n" +
	"\x13_addition_id_policyBm\n" +
