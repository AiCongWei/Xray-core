...
const file_transport_internet_config_proto_rawDesc = "" +
	"\n" +
	"\x1ftransport/internet/config.proto\x12\x17xray.transport.internet\x1a!common/serial/typed_message.proto\"t\n" +
	"\x0fTransportConfig\x12#\n" +
	"\rprotocol_name\x18\x03 \x01(\tR\fprotocolName\x12<\n" +
	"\bsettings\x18\x02 \x01(\v2 .xray.common.serial.TypedMessageR\bsettings\"\xd0\x02\n" +
	"\fStreamConfig\x12#\n" +
	...
	"\x13transportLayerProxy\x18\x02 \x01(\bR\x13transportLayerProxy\"a\n" +
	"\rCustomSockopt\x12\x14\n" +
	"\x05level\x18\x01 \x01(\tR\x05level\x12\x10\n" +
	"\x03opt\x18\x02 \x01(\tR\x03opt\x12\x14\n" +
	"\x05value\x18\x03 \x01(\tR\x05value\x12\x12\n" +
	"\x04type\x18\x04 \x01(\tR\x04type\"\x9f\a\n" +
	...
	"\vtcp_max_seg\x18\x11 \x01(\x05R\ttcpMaxSeg\x12 \n" +
	"\ftcp_no_delay\x18\x12 \x01(\bR\n" +
	"tcpNoDelay\x12\x1b\n" +
	"\ttcp_mptcp\x18\x13 \x01(\bR\btcpMptcp\x12L\n" +
	"\rcustomSockopt\x18\x14 \x03(\v2&.xray.transport.internet.CustomSockoptR\rcustomSockopt\"/\n" +
	"\n" +
	"TProxyMode\x12\a\n" +
	"\x03Off\x10\x00\x12\n" +
	"\n" +
