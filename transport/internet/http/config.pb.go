...
const file_transport_internet_http_config_proto_rawDesc = "" +
	"\n" +
	"$transport/internet/http/config.proto\x12\x1cxray.transport.internet.http\x1a,transport/internet/headers/http/config.proto\"\xe3\x01\n" +
	"\x06Config\x12\x12\n" +
	...
	"\x06header\x18\x06 \x03(\v2,.xray.transport.internet.headers.http.HeaderR\x06headerBv\n" +
